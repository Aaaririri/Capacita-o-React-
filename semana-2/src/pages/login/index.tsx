...
const Login: NextPage = () => {
    ...
    const handleLogin = () => {
        ...
        router.push({pathname: '/play', query: {username}})
        setError("")
    }


    return (
        <div className="flex flex-col items-center justify-center h-screen bg-blue-100 p-10">

            <h1 className="text-3xl font-semibold mb-5">
                Login
            </h1>

            <div className="flex flex-col items-center bg-indigo-300 p-5 border-0 rounded-lg space-y-4 shadow-md w-1/3">
                <input className="bg-slate-100 border-0 rounded-md p-3 font-semibold w-full"
                    type="text"
                    placeholder="Usuário"
